...
const emit = defineEmits<{(e: 'input', value: number): void; (e: 'key-frame'): void }>()
...
<template>
  <inspector-input-base :label="label">
    <div class="flex w-full">
      ...
      <svg viewBox="0 0 24 24" class="w-[16px] h-[16px] m-auto cursor-pointer select-none" @click="emit('key-frame')">
        <path
          v-if="!keyFrame"
          fill="currentColor"
