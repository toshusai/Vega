...
defineProps<{ label: string; value: number; keyFrame?: boolean; hasKeyFrame?:boolean }>()
  ...
  <inspector-input-base :label="label">
    <div style="display: flex; width: 100%">
      ...
      <v-icons
        ...
        viewBox="0 0 24 24"
        class="icon"
        :path="hasKeyFrame ? mdiRhombus : mdiRhombusOutline"
        :fill="hasKeyFrame ? 'orange' : 'currentColor'"
